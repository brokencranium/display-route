...
import static util.MathUtil.hav;
import static util.MathUtil.havDistance;
import static util.MathUtil.havFromSin;
import static util.MathUtil.inverseMercator;
import static util.MathUtil.mercator;
import static util.MathUtil.sinFromHav;
import static util.MathUtil.sinSumFromHav;
import static util.MathUtil.wrap;

/**
 * Created by vvennava on 10/13/14.
 */
