...
public final class GeofenceUtils {
    ...
    public static final String ACTION_CONNECTION_ERROR =
            "com.vv.buildstuff.displayroute.ACTION_CONNECTION_ERROR";

    public static final String ACTION_CONNECTION_SUCCESS =
            "com.vv.buildstuff.displayroute.ACTION_CONNECTION_SUCCESS";

    public static final String ACTION_GEOFENCES_ADDED =
            "com.vv.buildstuff.displayroute.ACTION_GEOFENCES_ADDED";

    public static final String ACTION_GEOFENCES_REMOVED =
            "com.vv.buildstuff.displayroute.ACTION_GEOFENCES_DELETED";

    public static final String ACTION_GEOFENCE_ERROR =
            "com.vv.buildstuff.displayroute.ACTION_GEOFENCES_ERROR";

    public static final String ACTION_GEOFENCE_TRANSITION =
            "com.vv.buildstuff.displayroute.ACTION_GEOFENCE_TRANSITION";

    public static final String ACTION_GEOFENCE_TRANSITION_ERROR =
                    "com.vv.buildstuff.displayroute.ACTION_GEOFENCE_TRANSITION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
                    "com.vv.buildstuff.displayroute.CATEGORY_LOCATION_SERVICES";
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.vv.buildstuff.displayroute.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.vv.buildstuff.displayroute.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.vv.buildstuff.displayroute.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.vv.buildstuff.displayroute.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.vv.buildstuff.displayroute.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.vv.buildstuff.displayroute.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.vv.buildstuff.displayroute.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.vv.buildstuff.displayroute.KEY_TRANSITION_TYPE";

    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "com.vv.buildstuff.displayroute.KEY";
